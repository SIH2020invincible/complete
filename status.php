...
<body style="background-color:powderblue;">
  ...
  <h1>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;Absenties</h1>
 <p></p>
 <br>
 <p></p>
...
$sql = "SELECT name,address,contact FROM user WHERE username='".$username."'and attendance!='p' ";
